...
check_points = ["result_"+a+"_" +
                str(b)+".out" for a, b in zip(cnfs, check_points_start)]


end_props_int = [100000000 for i in check_points_start]
...
commands = ["mkdir {};cd {};ln -sf ../DDR4_4Gb_x16_2133_2.ini ./;ln -sf ../mesh ./;ln -sf ../satacc_config.txt ./;ln -sf ../*.cfg ./; {}   {}  > result_{}.txt 2> result_{}.err".format(
    c, c, minisat_path,  os.path.join(cnf_root, c), c, c) for c, checkpoint, end_prop in zip(cnfs, check_points, end_props)]
